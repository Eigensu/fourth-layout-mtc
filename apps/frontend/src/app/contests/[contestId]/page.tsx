        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 items-stretch">
            ...
            <button
              ...
              className="w-full h-full rounded-3xl bg-gradient-to-br from-white via-primary-50 to-primary-100 transition transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-4 focus:ring-primary/20"
            >
